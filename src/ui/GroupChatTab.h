...
class GroupChatTab : public QWidget
{
   ...
   public:
    explicit GroupChatTab(ChatClient* client, const QString& nickname, QWidget* parent = nullptr);
    void appendMessage(const QString& sender, const QString& content, const QString& timestamp);
